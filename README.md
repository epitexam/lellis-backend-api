...
Lellis uses a **hybrid authorization model**:

- **RBAC (Role-Based Access Control)** to define structural permissions.
- **ABAC (Attribute-Based Access Control)** to enforce contextual and medical-specific rules.
...
- secure API access through an API Gateway,
- microservices-oriented backend,
- centralized identity and authorization service,
...
- Tauri (Desktop)
- Web and mobile clients planned
...
- authorization model (RBAC + ABAC foundations),
- stable backend API,
- desktop client,
